...
def _match_conditions(metrics, conditions):
    value = metrics.get("motion_score", 0)
    return value >= conditions["motion_score"]["gte"]
app_services_alert_engine._match_conditions = _match_conditions
