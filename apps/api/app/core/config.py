...
class Settings(BaseSettings):
    ...
    object_store: str = Field(default="local", validation_alias="OBJECT_STORE")
    object_store_bucket: str = Field(default="takeout-guard-evidence", validation_alias="OBJECT_STORE_BUCKET")
    object_store_endpoint_url: str = Field(default="", validation_alias="OBJECT_STORE_ENDPOINT_URL")
    object_store_access_key: str = Field(default="", validation_alias="OBJECT_STORE_ACCESS_KEY")
    object_store_secret_key: str = Field(default="", validation_alias="OBJECT_STORE_SECRET_KEY")
    object_store_region: str = Field(default="us-east-1", validation_alias="OBJECT_STORE_REGION")
    object_store_presign_ttl_sec: int = Field(default=300, validation_alias="OBJECT_STORE_PRESIGN_TTL_SEC")
    ...
    require_device_hmac: bool = Field(default=False, validation_alias="REQUIRE_DEVICE_HMAC")
    device_signature_ttl_sec: int = Field(default=300, validation_alias="DEVICE_SIGNATURE_TTL_SEC")
    ...
    run_background_tasks: bool = Field(default=False, validation_alias="RUN_BACKGROUND_TASKS")
